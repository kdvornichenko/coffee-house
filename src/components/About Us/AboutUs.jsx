	...
	return (
		<div className={styles.AboutUs}>
			...
			<p className={styles.AboutUs_Text}>
				...
				improve an. Last ask him cold feel met spot shy want. Children me
				laughing we prospect answered followed. At it went is song that held
				help face. <br />
				<br /> Now residence dashwoods she excellent you. Shade being under his
